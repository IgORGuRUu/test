...
<li><a href='/css/css_background.asp'>CSS Backgrounds</a></li>
<li><a href='/css/css_background_shorthand.asp'>Background Shorthand</a></li>
<li>Tryit: Background shorthand property</li>
</ul>
</div>
  ...
  <div id="navbarDropMenu" class="w3-dropdown-content w3-bar-block w3-border" style="z-index:5">
    ...
    <footer class="w3-container w3-small ws-grey">
      <p>
        ...
        <a style="display:inline;padding:0;" href="/about/about_copyright.asp" target="_blank" onclick="openMenu();" class="w3-hover-none ws-hover-text-green">Copyright 1999-2023</a>
      </p>
    </footer>
  </div>
...
<script src="/lib/spaceit.js?v=1.0.3"></script>
